...
app.use(express.static(path.join(__dirname, 'dist/twisted-mountain-assignment')));

app.get('/*', function(req, res) {
    res.sendFile(path.join(__dirname, 'dist/twisted-mountain-assignment/index.html'));
});
